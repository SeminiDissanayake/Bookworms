...
<title>Untitled Document</title>
    <style>
    @import url("images/Books-and-laptop-.webp");
...
body {
	...
	height: 100vh;
	margin: -20px 0 50px;
	background-image: url("images/th (15).jpg");
...
.overlay {
	...
	background: linear-gradient(to right, #31ADC7, #1334B1);
...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
		<form action="loginHandler.php" method="post">
		    ...
		    <div class="social-icons"> <a href="https://www.facebook.com/"><img src="images/th (8).jpg" width="30" height="30"></a>&nbsp;&nbsp;&nbsp;
			<a href="https://www.google.com/"><img src="images/th (10).jpg" width="50" height="50"></a></div>
